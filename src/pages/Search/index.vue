            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: activeOne}" @click="changeOrder('1')">
                  <a>综合 <span v-show="activeOne" class="iconfont" :class="{'icon-arrowup': isAsc, 'icon-arrowdown': isDesc}"></span></a>
                </li>
                 <li :class="{active: activeTwo}" @click="changeOrder('2')">
                  <a>价格 <span v-show="activeTwo" class="iconfont" :class="{'icon-arrowup': isAsc, 'icon-arrowdown': isDesc}"></span></a>
                </li>
                ...
                <div class="list-wrap">
                  <div class="p-img">
                    ...
                    <router-link :to="`/detail/${good.id}`">
                      <!-- <img :src="good.defaultImg" :key="index"/> -->
                      <img v-lazy="good.defaultImg" :key="index"/>

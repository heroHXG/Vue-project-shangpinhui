          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr, index) in spuSaleAttrList" :key="attr.id">
                ...
                <dd  v-for="(sale, index) in attr.spuSaleAttrValueList" :key="sale.id"
                  changepirce="0" :class="{active: sale.isChecked==1}" @click="changeActive(sale, attr.spuSaleAttrValueList)">
